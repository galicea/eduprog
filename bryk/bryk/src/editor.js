...
BlockPyEditor.CATEGORY_MAP = {
    'Properties': '<category name="Zmienne/własności" custom="VARIABLE" colour="240">'+
                  '</category>',
    'Decisions': '<category name="Warunki" colour="330">'+
                  ...
                  '</category>',
    'Iteration': '<category name="Powtarzanie" colour="300">'+
                    '<block type="controls_forEach"></block>'+
                '</category>',
    'Functions': '<category name="Funkcje" custom="PROCEDURE" colour="210">'+
                '</category>',
    'Calculation': '<category name="Kalkulator" colour="270">'+
    ...
    'Python':   '<category name="Python" colour="180">'+
                ...
                '</category>',
    'Output':   '<category name="Drukuj wynik" colour="160">'+
                ...
                '</category>',
    'Values':   '<category name="Wartości" colour="100">'+
                    '<block type="text"></block>'+
                    '<block type="math_number"></block>'+
                    '<block type="logic_boolean"></block>'+
                '</category>',
    'Lists':    '<category name="Listy" colour="30">'+
                    ...
                    '</block>'+*/
                '</category>',
    'Dictionaries': '<category name="Słowniki" colour="0">'+
